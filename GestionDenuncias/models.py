...
class ActasTerreno(models.Model):
    ...
    candidato_gore = models.CharField(max_length=255, null=True, blank=True)
    rut_gore = models.CharField(max_length=255, null=True, blank=True)
    partido_gore = models.CharField(max_length=255, null=True, blank=True)
    mail_gore = models.CharField(max_length=255, null=True, blank=True)
    candidato_core = models.CharField(max_length=255, null=True, blank=True)
    rut_core = models.CharField(max_length=255, null=True, blank=True)
    partido_core = models.CharField(max_length=255, null=True, blank=True)
    territorio_core = models.CharField(max_length=255, null=True, blank=True)
    mail_core = models.CharField(max_length=255, null=True, blank=True)
    candidato_alcalde = models.CharField(max_length=255, null=True, blank=True)
    territorio_alcalde = models.CharField(max_length=255, null=True, blank=True)
    rut_alcalde = models.CharField(max_length=255, null=True, blank=True)
    partido_alcalde = models.CharField(max_length=255, null=True, blank=True)
    mail_alcalde = models.CharField(max_length=255, null=True, blank=True)
    candidato_concejal = models.CharField(max_length=255, null=True, blank=True)
    territorio_concejal = models.CharField(max_length=255, null=True, blank=True)
